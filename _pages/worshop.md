...
This workshop brings together researchers working at the interface of **artificial intelligence and mathematics**, with a focus on emerging **foundations, methodologies, and systems for AI-driven mathematical reasoning and discovery**.

The program covers a range of topics including **formal methods and proof assistants**, **automated and interactive theorem proving**, **machine learning approaches to mathematical discovery**, as well as interactions with core areas such as **geometry**, **analysis**, **probability**, and **mathematical physics**. A central theme of the workshop is the integration of **verifiable reasoning** and **data-driven methodologies**, and how these paradigms can be combined to advance the **scope**, **efficiency**, and **reliability** of mathematical exploration.

The workshop is designed as a **focused, invitation-based meeting**, bringing together a small group of researchers for **in-depth technical discussions**. Rather than emphasizing breadth, the goal is to foster **high-level exchange**, clarify key conceptual directions, and explore **future research frontiers in AI for Mathematics**.
### Schedule
...
* **Zoom Meeting ID: 831 6276 0618** and **Passcode: 478468**
...
He works on the interface between geometry, number theory and string theory. In 2017, he helped launch the emerging field of AI-guided mathematical discovery.

We would greatly appreciate your participation and your help in sharing this invitation with members of your research group, especially junior members/students.
For any inquiries, please contact zliu@simis.cn or ziran.liu@nyu.edu.
