---
layout: page
title: AI for Mathematics Colloquium and Workshop @SIMIS
permalink: /workshop/
description: April 6 and 7, 2026 | SIMIS, Shanghai
nav: false
---
...
### About the SIMIS Colloquium and Workshop

This SIMIS Colloquium and Workshop bring together researchers working at the interface of <span style="color: var(--global-theme-color); font-weight: bold;">artificial intelligence and mathematics</span>, with a focus on emerging <span style="color: var(--global-theme-color); font-weight: bold;">foundations, methodologies, and systems for AI-driven mathematical reasoning and discovery</span>.

The program covers a range of topics including <span style="color: var(--global-theme-color); font-weight: bold;">formal methods and proof assistants</span>, <span style="color: var(--global-theme-color); font-weight: bold;">automated and interactive theorem proving</span>, <span style="color: var(--global-theme-color); font-weight: bold;">machine learning approaches to mathematical discovery</span>, as well as interactions with core areas such as geometry, analysis, probability, and mathematical physics. A central theme of the workshop is the integration of <span style="color: var(--global-theme-color); font-weight: bold;">verifiable reasoning</span> and <span style="color: var(--global-theme-color); font-weight: bold;">data-driven methodologies</span>, and how these paradigms can be combined to advance the scope, efficiency, and reliability of mathematical exploration.

The workshop is designed as a <span style="color: var(--global-theme-color); font-weight: bold;">focused, invitation-based meeting</span>, bringing together a small group of researchers for in-depth technical discussions. Rather than emphasizing breadth, the goal is to foster high-level exchange, clarify key conceptual directions, and explore <span style="color: var(--global-theme-color); font-weight: bold;">future research frontiers in AI for Mathematics</span>.
...
* <span style="color: var(--global-theme-color); font-weight: bold;">Zoom Meeting ID: 831 6276 0618</span> | <span style="color: var(--global-theme-color); font-weight: bold;">Passcode: 478468</span>
...
### 09:00–09:10  
<span style="color: var(--global-theme-color); font-weight: bold;">Shing-Tung Yau</span>
...
### 09:10–09:55  
<span style="color: var(--global-theme-color); font-weight: bold;">Yang-Hui He</span> *(in person)* *The AI Mathematician*
...
### 10:50–11:35  
<span style="color: var(--global-theme-color); font-weight: bold;">Leonardo de Moura</span> *(remote)* *Lean: Machine-Checked Mathematics and Verified Programming*
...
### 11:55–12:40  
<span style="color: var(--global-theme-color); font-weight: bold;">Yijun Yuan</span> *(in person)* *Formalization of Non-Archimedean Functional Analysis*
...
### 14:10–14:55  
<span style="color: var(--global-theme-color); font-weight: bold;">Bin Dong</span> *(in person)* *AI for Mathematics: From Digitization to Automated Reasoning*
...
### 15:00–15:45  
<span style="color: var(--global-theme-color); font-weight: bold;">Lihong Zhi</span> *(in person)* *Algebraic Reasoning in Formal Mathematics*
...
### 16:55–17:40  
<span style="color: var(--global-theme-color); font-weight: bold;">Kevin Buzzard</span> *(remote)* *The Role of Autoformalisation in Mathematics*
