...
My research is on both <a href="#" onclick="return false;" style="color:var(--link-color, currentColor); text-decoration:none;">Mathematics and AI</a>, spanning <a href="#" onclick="return false;" style="color:var(--link-color, currentColor); text-decoration:none;">math for AI</a> and <a href="#" onclick="return false;" style="color:var(--link-color, currentColor); text-decoration:none;">AI for math</a>. Mathematically, my work is rooted in <a href="#" onclick="return false;" style="color:var(--link-color, currentColor); text-decoration:none;">probability theory</a> and <a href="#" onclick="return false;" style="color:var(--link-color, currentColor); text-decoration:none;">differential geometry</a>, and these also remain the central topics to my work in pure mathematics. I move in both directions: I develop new mathematics for AI, and I apply mathematical structure into methods for solving problem in learning theory — while also exploring how AI can contribute back to mathematics. My projects always come as dual programs: a foundational mathematical line that is motivated by AI and a companion AI track to apply the developed mathematics.
